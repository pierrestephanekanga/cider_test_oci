...
class Featurizer:
    ...
    def cdr_features(self, bc_chunksize: int = 10000, bc_processes: int = 55) -> None:
        """
        ...
        print('conversion cdr_bandicoot ok')
        ...
        print('subscribers file create ok')
        print('number subscribers = ', len(subscribers))
        ...
        while end < len(subscribers):
            ...
            print('calculate bandicoot feature')
